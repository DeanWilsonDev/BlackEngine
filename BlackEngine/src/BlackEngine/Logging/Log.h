...
// Client Log Macros
#define LOG_TRACE(...) BlackEngine::Logging::Log::GetClientLogger()->trace(__VA_ARGS__)
#define LOG_DEBUG(...) BlackEngine::Logging::Log::GetClientLogger()->debug(__VA_ARGS__)
#define LOG_INFO(...) BlackEngine::Logging::Log::GetClientLogger()->info(__VA_ARGS__)
#define LOG_WARN(...) BlackEngine::Logging::Log::GetClientLogger()->warn(__VA_ARGS__)
#define LOG_ERROR(...) BlackEngine::Logging::Log::GetClientLogger()->error(__VA_ARGS__)
#define LOG_FATAL(...)                                                          \
